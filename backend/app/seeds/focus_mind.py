...
- Nie chodzi o idealne liczby – ważne, że w tym czasie jesteś przy JEDNYM zadaniu.
...
QUIZ_QUESTIONS: List[Dict] = [
    ...
    },
    {
        "order": 8,
        "question":
            "Co jest najważniejsze podczas przerwy między blokami pracy?",
        "options": [
...
TASKS: List[Dict] = [
    {
        ...
        "body": "Dzisiaj zaczniesz świadomie patrzeć na to, jak pracujesz. Proste kroki, bez filozofii.",
        "difficulty": "easy",
        "checklist": [
...
def seed_focus_module(db: Session) -> None:
    """
    Seed dla modułu MIND / Focus.
    Wywołaj tę funkcję z run_seed_if_empty(db) albo z własnego loadera.
    """
    # Czy już istnieją lekcje dla tego modułu?
    existing = (
        db.query(Lesson)
